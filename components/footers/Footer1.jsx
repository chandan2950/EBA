      ...
      <div className="tf-container">
        <div className="row">
          <div className="col-12">
            <div className="footer-top" style={{ display: "flex", flexWrap: "wrap", alignItems: "flex-start", gap: "20px" }}>
              <div className="contact-item">
                <div className="icons">
                  <i className="icon-phone-2" />
                </div>
                <div className="content">
                  <div className="title text-1" style={{ color: "#fff" }}>Call us</div>
                  <h6>
                    <a href="#" style={{ color: "#fff" }}> +91 9326126874</a>
                  </h6>
                </div>
              </div>
              <div className="contact-item">
                ...
                <div className="content">
                  <div className="title text-1" style={{ color: "#fff" }}>Need help?</div>
                  <h6 className="fw-4">
                    <a href="#" style={{ color: "#fff" }}>business@dmeba.in</a>
                  </h6>
                </div>
              </div>
              <div className="contact-item">
                ...
                <div className="content">
                  <div className="title text-1" style={{ color: "#fff" }}>Business Bay Office</div>
                  <h6 className="fw-4" style={{ maxWidth: "280px", color: "#fff", fontSize: "13px" }}>
                    805, Kamdhenu Commerz, beside Raghunath Vihar, Sector-13, Kharghar, Navi Mumbai, Maharashtra Pin - 410210
                  </h6>
                </div>
              </div>
              <div className="contact-item">
                ...
                <div className="content">
                  <div className="title text-1" style={{ color: "#fff" }}>Corporate Office</div>
                  <h6 className="fw-4" style={{ maxWidth: "280px", color: "#fff", fontSize: "13px" }}>
                    414, Corporate Annexe, Sonawala Rd, near Udyog Bhavan, Goregaon, Mumbai, Maharashtra 400063
                  </h6>
                </div>
              </div>
            </div>
        ...
        <div className="col-12">
          <div className="footer-bottom">
            <div className="footer-copyright">
              <p>
                Copyright ©2025 EBA DM Projects Private Limited
              </p>
