...
export default function Gallery() {
  ...
  return (
    <>
      <section className="section-gallery tf-spacing-1 bg-surface">
          ...
          <div className="row">
            <div className="col-12">
              <div className="heading-section mb-48 text-center">
                ...
                <p className="text-1 mt-12">
                  Explore our portfolio of successful redevelopment projects
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="gallery-marquee-wrapper">
              <div className="gallery-marquee">
                {[...galleryImages, ...galleryImages].map((image, index) => (
                  ...
                  >
                    <div className="gallery-image-wrapper-mobile">
                      <Image
                        src={image}
